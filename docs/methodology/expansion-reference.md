# Technical reference for literature expansion

This document preserves the detailed methodological rules used for audit and
reproducibility. For the shorter operational explanation, start with
