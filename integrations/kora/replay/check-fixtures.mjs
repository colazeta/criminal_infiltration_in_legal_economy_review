...
const result={passed:true,count:files.length,checks:['Kora Test JSON schema','Target node input JSON schema','YAML 1.1 scheduled_at remains string'],boundary:'Offline schema checks, not native Kora execution'};
