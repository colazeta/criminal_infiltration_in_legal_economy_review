...
class RetrievalResolutionTests(unittest.TestCase):
    ...
    def test_workflows_make_resolution_persistent_and_self_applying(self) -> None:
        ...
        helper = (ROOT / "scripts/retrieval/persist_selected_support.sh").read_text(encoding="utf-8")
        ...
        self.assertIn("persistence_pending", helper)
        self.assertIn('-f sha="$head_sha"', helper)
        self.assertNotIn("HEAD:main", workflow)
        self.assertNotIn("HEAD:main", helper)
