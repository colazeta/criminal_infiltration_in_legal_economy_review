...
def verify_sheet_support(register_url: str, expected_register: Path) -> dict:
    ...
    for name in ('paper-register.js', 'paper-sheet-support.js', 'paper-sheet-research.js', 'index.html', 'styles.css', 'bibliometrics.js', 'study-geography.js', 'stats.html', 'bibliometrics.css'):
